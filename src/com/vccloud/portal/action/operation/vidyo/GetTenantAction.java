...
public class GetTenantAction extends BaseAction {
	...
	public JSONObject doApiAction(HttpServletRequest request,
		...
		try {
			...
			Tenant4SuperExtVO tenant = vidyoService.getTenant(tenantId2);
			JSONObject result = new JSONObject();
			result.put("result", "ok");
			result.put("acl", tenant.getPortalInfo().getAcl());
			result.put("tenant", tenant.toJson());
			return result;
